...
import com.zhimu.news.utils.DpAndPxUtils;
...
public class DragItemGridView extends GridView {
    ...
    public DragItemGridView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    public DragItemGridView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    public void init(Context context) {
        ...
        // 将布局文件中设置的间距dip转为px
        mHorizontalSpacing = DpAndPxUtils.dip2px(context, mHorizontalSpacing);
    }
...
//		if (tempPostion != AdapterView.INVALID_POSITION) {
        ...
        DragGridViewAdapter mDragGridViewAdapter = (DragGridViewAdapter) getAdapter();
        // 显示刚拖动的ITEM
        mDragGridViewAdapter.setShowDropItem(true);
        // 刷新适配器，让对应的ITEM显示
    ...
    public void setOnItemClickListener(final MotionEvent ev) {
        setOnItemLongClickListener(new OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view,
                ...
                itemTotalCount = DragItemGridView.this.getCount();
                // 算出行数
                ...
                if (dragPosition != AdapterView.INVALID_POSITION) {
                    ...
                    // 手指在屏幕的上X位置-手指在控件中的位置就是距离最左边的距离
                    dragOffsetX = (int) (ev.getRawX() - x);
                    // 手指在屏幕的上y位置-手指在控件中的位置就是距离最上边的距离
                    ...
                    moveAnimation.setAnimationListener(new AnimationListener() {
                        ...
                        public void onAnimationEnd(Animation animation) {
                            ...
                            if (animation.toString().equalsIgnoreCase(mLastAnimationID)) {
                                DragGridViewAdapter mDragGridViewAdapter = (DragGridViewAdapter) getAdapter();
                                mDragGridViewAdapter.exchange(startPosition, dropPosition);
