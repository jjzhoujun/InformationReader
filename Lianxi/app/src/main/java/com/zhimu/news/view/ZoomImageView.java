...
/**
 * 可以缩放图片
 * 参考github上例子：https://github.com/bm-x/PhotoView
 * 感谢：bm-x
 *
 */
...
//            mScaleCenter.set(detector.getFocusX(), detector.getFocusY());
    ...
    public ZoomImageInfo getInfo() {
        ...
        return new ZoomImageInfo(rect, local, mImgRect, mWidgetRect, mScale, mDegrees, mScaleType);
    }
